...
async def create_kobo_account(user_data: dict):
    """
    ...
    KOBOTOOLBOX_ADMIN_PASSWORD = "3cvnyAlgLd8qylGVKe9G"

    user_info = {
        "username": user_data.get('login'),
        "password": 123456,
        "email": user_data.get('mail'),
        "first_name": user_data.get('prenom'),
        "last_name": user_data.get('nom')
    }
...
async def main():
    ...
    with open('automation/assets/import_users_v2.json', 'r') as f:
        users = json.load(f)
