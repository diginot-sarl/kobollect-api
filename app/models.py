...
class Avenue(Base):
    ...
    etat = Column(Integer, nullable=True)
    lon = Column(Float(precision=18, scale=4), nullable=True)
    lat = Column(Float(precision=18, scale=4), nullable=True)
...
class Parcelle(Base):
    ...
    fk_unite = Column(Integer, ForeignKey("unite.id"), nullable=True)
    longueur = Column(Float(precision=18, scale=4), nullable=True)
    largeur = Column(Float(precision=18, scale=4), nullable=True)
    superficie_calculee = Column(Float(precision=18, scale=4), nullable=True)
